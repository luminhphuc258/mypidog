...
# index 0 la phan neck pitch, index 3 la phan mat tren cung theo chieu am, index 1 la co qua phai trai, mac dinh la -90 nhin thang, index 2 là co qua truoc sai
HEAD_INIT_ANGLES = [20, -45, -80]
