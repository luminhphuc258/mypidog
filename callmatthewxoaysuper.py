...
from matthewpidogclassinit import MatthewPidogBootClass   # ⬅️ thêm import
...
# 🔁 Góc đích (có thể đổi theo ý bạn)
P5_TARGET = 4       # ví dụ xoay về +4°
P7_TARGET = -1      # ví dụ xoay về -1°
...
def main():
    ...
    print("=== STEP 3: Alternating move P5,P7 with P4,P6 locked ===")
